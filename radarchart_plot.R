require(fmsb)
mydat<-read.csv("C://users//devesh23//desktop//Visualization using R//minmax.csv")
 #decrease default margin

for(i in 1:100){
  jpeg(file = paste("C://users//devesh23//desktop//plot results//finalplot1",i,".jpeg",sep=""),width=800,height=800,units="px",quality=200)
  par(mar=c(1, 2, 2, 1))
